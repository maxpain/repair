...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { city: @manufacturer.city, country: @manufacturer.country, description: @manufacturer.description, title: @manufacturer.title }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { city: @manufacturer.city, country: @manufacturer.country, description: @manufacturer.description, title: @manufacturer.title }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
